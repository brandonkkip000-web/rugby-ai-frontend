        ...
        <CardContent className="p-4">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <div className="font-bold text-lg">{team.stats.points}</div>
        ...
        {showStats && (
          <>
            <div className="grid grid-cols-3 gap-4 text-center">
              ...
              <div>
                <div className="text-2xl font-bold text-blue-600">{team.stats.tries}</div>
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div className="bg-green-50 p-2 rounded">
                ...
                <div className="text-green-600 font-bold">{team.stats.possession}%</div>
              </div>
              <div className="bg-blue-50 p-2 rounded">
                <div className="font-medium">Territory</div>
                <div className="text-blue-600 font-bold">{team.stats.territory}%</div>
              </div>
            </div>
          </>
        )}
